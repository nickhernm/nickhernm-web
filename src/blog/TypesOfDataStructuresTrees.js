...
const TreeTypes = () => (
  <PostWrapper>
    ...
    <PostContent>
      <p>Data structures are a crucial part of programming. One of the most important types of data structures is trees. Here, we will discuss several types of trees:</p>
      <ul>
        <li>Binary Trees</li>
